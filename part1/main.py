...
# print('softmax test_error (temp_parameter = 0.5) =', run_softmax_on_MNIST(temp_parameter=0.5))
# print('softmax test_error (temp_parameter = 2) =', run_softmax_on_MNIST(temp_parameter=2))
...
#
# theta, cost_function_history = softmax_regression(train_pca, train_y, temp_parameter,
...
theta, cost_function_history = softmax_regression(train_cube, train_y, temp_parameter,
                                                  alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
test_error = compute_test_error(test_cube, test_y, theta, temp_parameter)


print('softmax pca10 with cubic feature test_error=', test_error)